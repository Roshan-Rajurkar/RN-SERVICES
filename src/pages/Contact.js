...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        const serviceId = 'service_zdvm467';
        const templateId = 'template_619nybr';
        const userId = 'rzj16BGu10hxA8RBm';
    ...
    return (
        <div id="contact">
            <div className="flex justify-center items-center mt-2 w-full bg-white py-4 lg:py-4 bg-gray-200">
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">shop no 11, jograna complex, gardiyadhar road, <br /> palitana, Bhavnagar, Gujarat, india -364270</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Mo : 9909575962</p>

                                    <div className='mt-5'>
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">rnservices5125@gmail.com</p>
                                    </div>
